...
public abstract class TaskActivity<StateType> extends AbstractActivity<StateType> implements ActivityStateListener
{
     ...
     * (non-Javadoc)
     * 
     * @see org.hypergraphdb.peer.workflow.ActivityStateListener#stateChanged(java.lang.Object,
     *      org.hypergraphdb.peer.workflow.AbstractActivity)
     * 
    ...
    public void handleMessage(Object msg)
    {
        ...
        Conversation<?> conversation = conversations.get(getPart(msg,
        ...
        if (conversation == null)
        {
            ...
            if (conversation != null)
                registerConversation(conversation,
                                     (UUID) getPart(msg, CONVERSATION_ID));
        }
