...
public class HGSubgraph implements HyperNode, HGHandleHolder, HGGraphHolder
{
    ...
    {
        return add(graph.add(atom, type));
    }
    ...
    public IncidenceSet getIncidenceSet(HGHandle handle)
    {
        ...
        return new IncidenceSet(handle, new FilteredSortedSet<HGHandle>(graph
                .getIncidenceSet(handle), memberPredicate));
    }
