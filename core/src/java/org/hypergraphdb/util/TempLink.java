 ...
 * traversal activities. It is just a <code>HGLink</code> wrapper around an array
 * of <code>HGHandle</code>s. It is needed by APIs that rely solely on the <code>HGLink</code>
 * interface, but need to work with temporary link representations in the frorm of 
 * <code>HGHandle[]</code>.
 * </p>
 *  
 * <p>
 * Note that the implementation never checks for null when accessing its HGHandle array
 * argument. 
 * </p>
 * 
