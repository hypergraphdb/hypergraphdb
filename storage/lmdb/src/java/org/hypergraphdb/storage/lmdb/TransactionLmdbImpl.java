...
public class TransactionLmdbImpl implements HGStorageTransaction {
	...
	public TransactionLmdbImpl(LmdbStorageImplementation storeImpl, HGHandleFactory handleFactory, Transaction t,
			Env env, boolean readOnly) {
	...
	private HGPersistentHandle getNextStorageHandle() {
		if (handleFactory instanceof LongHandleFactory) {
			...
			throw new IllegalStateException("Incompatible handle Factory type " + handleFactory);
		}
	}
}