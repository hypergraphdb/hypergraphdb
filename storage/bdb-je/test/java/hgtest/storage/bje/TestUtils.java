...
public class TestUtils
{
     ...
     * {@link org.hypergraphdb.HGRandomAccessResult}. Two results cannot be compared directly. So
			...
			final Database database, final Integer key, final Integer value)
	{
		...
		database.put(
				...
				new DatabaseEntry(new ByteArrayConverterForInteger()
						.toByteArray(key)),
				new DatabaseEntry(new ByteArrayConverterForInteger()
						.toByteArray(value)));
			...
			final String value)
	{
		realCursor.put(
				new DatabaseEntry(new ByteArrayConverterForInteger()
						.toByteArray(key)),
				new DatabaseEntry(new ByteArrayConverterForString()
						.toByteArray(value)));
	}
}
