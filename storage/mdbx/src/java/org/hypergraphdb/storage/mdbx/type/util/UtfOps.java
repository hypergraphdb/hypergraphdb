package org.hypergraphdb.storage.mdbx.type.util;
...
public class UtfOps
{
	 ...
	 *
	 * @param bytes
	 *            the data containing the UTF string.
	 *
	 * @param offset
	 *            the beginning of the string the measure.
	 *
	 * @throws IndexOutOfBoundsException
	 *             if no zero terminator is found.
	 *
	 ...
	 *
	 * @param offset
	 *            the first character to be converted.
	 *
	 * @param length
	 ...
	 *
	 * @throws IndexOutOfBoundsException
	 *             if a UTF character sequence at the end of the data is not
	 *             complete.
	 *
	 * @throws IllegalArgumentException
	 *             if an illegal UTF sequence is encountered.
	 */
	 ...
	 *
	 * @param offset
	 *            the first byte to be converted.
	 *
	 * @param length
	 ...
	 *
	 * @param bytes
	 *            the source byte data to convert
	 *
	 * @param byteOffset
	 *            the offset into the byte array at which to start the
	 *            conversion
	 *
	 * @param chars
	 ...
	 *
	 * @param charOffset
	 *            the offset into chars at which to begin the copy
	 *
	 * @param len
	 *            the amount of information to copy into chars
	 *
	 * @param isByteLen
	 *            if true then len is a measure of bytes, otherwise len is a
	 *            measure of characters
	 *
	 * @throws IndexOutOfBoundsException
	 *             if a UTF character sequence at the end of the data is not
	 *             complete.
	 ...
	 *             if an illegal UTF sequence is encountered.
	 */
	public static int bytesToChars(byte[] bytes, int byteOffset, char[] chars,
			int charOffset, int len, boolean isByteLen)
			throws IllegalArgumentException, IndexOutOfBoundsException
	{
	 ...
	 *
	 * @param charOffset
	 *            the offset into the character array at which to start the
	 *            conversion
	 *
	 * @param bytes
	 *            the destination array
	 ...
	 *
	 * @param charLength
	 *            the length of characters to copy into bytes
	 */
	public static void charsToBytes(char[] chars, int charOffset, byte[] bytes,
			int byteOffset, int charLength)
	{
