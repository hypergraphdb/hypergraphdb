 ...
 *
 * <p>
 * <em>WARNING:</em> Binding instances are typically shared by multiple threads
 * and binding methods are called without any special synchronization.
 * Therefore, bindings must be thread safe. In general no shared state should be
