...
public class FastOutputStream extends OutputStream
{
	 ...
	 *
	 * @param bumpSize
	 *            the amount to increment the buffer.
	 */
	 ...
	 *
	 * @param buffer
	 *            the initial buffer; will be owned by this object.
	 */
	 ...
	 *
	 * @param bumpSize
	 *            the amount to increment the buffer. If zero (the default), the
	 *            current buffer size will be doubled when the buffer is full.
	 */
