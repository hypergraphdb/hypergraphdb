 ...
 * 
 * <p>
 * Test the creation of HGDB types from Java classes. Each tests adds an atom of a new type
 * that the HGDB type system is supposed to map properly, reopens the DB and verify that the
 * value is the same through a "deep" equals comparison.
 * </p>
 */
public class TypeInferenceTests extends HGTestBase
{
    ...
    public void testConstructibleLinks()
    {
        ...
        BeanLink1 l = new BeanLink1(14, new String[] {"x","y","z"}, new HGHandle[]{x,y,z});
        ...
        basics.executeAndVerify(new AtomOperation[]
          {          
              new AtomOperation(remove, x),
              new AtomOperation(remove, y) ,
              new AtomOperation(remove, z)           
          }, 
          false,
          false,
          true);        
    ...
    {
        basics.executeAndVerify(new AtomOperation(add, new PrivateConstructible("from test")), true, true);
    }  
